package constructors.complexNumber;
...
// and b is called the imaginary part. To add or subtract two complex numbers, just add or
// subtract the corresponding real and imaginary parts. For instance, the sum of 5 + 3i and 4 + 2i is 9 + 5i.
...
//
//The class needs to have one constructor. The constructor has parameters real and imaginary of type double and
